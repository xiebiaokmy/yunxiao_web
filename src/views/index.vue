<template>
  <div class="index">
    <div class="banner">
      <el-carousel trigger="click" height="10.64rem">
    ...
    <div class="con-serve">
      ...
      <div class="carousel">
        <el-carousel trigger="click" height="7.2rem">
          <el-carousel-item>
            <div class="each">
    ...
    <div class="news">
      ...
      <div class="news-box">
        <div class="each-news" v-for="(item)  in newsList" :key="item.id">
          <div class="cover">
      ...
      newsList: [
        {
          ...
          title:
            "我是新闻我是新闻我是新闻我是新闻我是新闻我是新闻我是新闻我是新闻我是新闻我是新闻",
          brief:
            "在疫情过后，广告传媒人应当怎样做才能赢回先机？广告传媒企业又当如何发力广告传媒人应当怎样做才能赢回先机？广告传媒企业又当如何发力广告传媒人应当怎样做才能赢回先机？广告传媒企业又当如何发力",
          time: 1600856325000
        },
        {
          id2: 2,
